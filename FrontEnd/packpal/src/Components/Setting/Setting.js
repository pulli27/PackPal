                    ...
                    <div className="profile-info">
                      <div className="profile-field">
                        <div className="form-row">
                          ...
                          <div className="form-control-section">
                            <input type="text" className="form-input" defaultValue="Sanugi De Silva" placeholder="Enter your full name" />
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="form-row">
                          ...
                          <div className="form-control-section">
                            <input
                              ...
                              defaultValue="sanugisilva@gmail.com"
                        ...
                        <div className="form-row">
                          ...
                          <div className="form-control-section">
                            <select className="form-select" defaultValue="administrator">
                              <option value="administrator">Finance Manager</option>
                              <option value="manager">Inventory Manager</option>
                              <option value="employee">Product Manager</option>
